...
@FragmentScope
public class GoodsInOutPresenter extends BasePresenter<GoodsInOutContract.Model, GoodsInOutContract.View> {
    ...
    @Inject
    public GoodsInOutPresenter(GoodsInOutContract.Model model, GoodsInOutContract.View rootView
