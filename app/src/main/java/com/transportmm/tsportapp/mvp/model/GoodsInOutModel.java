...
@FragmentScope
public class GoodsInOutModel extends BaseModel implements GoodsInOutContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public GoodsInOutModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
