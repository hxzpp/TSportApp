...
public class ViewDragHelper {
    ...
    /**
     * A Command is used as a communication channel with the ViewDragHelper
    ...
    public static abstract class Callback {
         ...
         * {@link #flingCapturedView(int, int, int, int)}. If the Command
     ...
     * @param cb        Command to provide information and receive events
     ...
     * greater than zero in pixels per second. Command methods accepting a
     ...
     * magnitude less than this value in pixels per second. Command methods
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                for (int i = 0; i < pointerCount; i++) {
                    ...
                    if (mDragState == STATE_DRAGGING) {
                        // Command might have started an edge drag
                        break;
                    }
