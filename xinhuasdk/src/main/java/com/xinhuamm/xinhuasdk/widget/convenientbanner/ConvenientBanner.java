package com.xinhuamm.xinhuasdk.widget.convenientbanner;
...
import com.xinhuamm.xinhuasdk.widget.convenientbanner.adapter.CBPageAdapter;
import com.xinhuamm.xinhuasdk.widget.convenientbanner.holder.CBViewHolderCreator;
import com.xinhuamm.xinhuasdk.widget.convenientbanner.listener.CBPageChangeListener;
import com.xinhuamm.xinhuasdk.widget.convenientbanner.listener.OnItemClickListener;
import com.xinhuamm.xinhuasdk.widget.convenientbanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        loPageTurningPoint = (LinearLayout) hView.findViewById(R.id.loPageTurningPoint);
        initViewPagerScroll();
    ...
    static class AdSwitchTask implements Runnable {
        ...
        public void run() {
            ...
            if (convenientBanner != null) {
                if (convenientBanner.mDatas.size() == 1) {
                    return;
                }
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding(0, 0, (int) HDevice.dp2px(8, getContext()), 0);
            if (mPointViews.isEmpty())
                pointView.setImageResource(page_indicatorId[1]);
            else
                pointView.setImageResource(page_indicatorId[0]);
            mPointViews.add(pointView);
            loPageTurningPoint.addView(pointView, new LayoutParams(LayoutParams.WRAP_CONTENT,
