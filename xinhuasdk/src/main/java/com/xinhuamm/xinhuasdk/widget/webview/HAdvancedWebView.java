...
/**
 * 根据Android-AdvancedWebView改编的基于系统自带的WebView,
 * 提升速度
 */
...
public class HAdvancedWebView extends WebView {
    ...
    public HAdvancedWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public HAdvancedWebView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onDestroy() {
        ...
        //可以解决这个问题java.lang.IllegalArgumentException
        //Receiver not registered: android.widget.ZoomButtonsController$1@424bb098
        try {
            removeAllViews();
        } catch (Exception ignored) {
        }
    ...
    protected void init(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 17 && HDevice.isWifiOpen(getContext())) {
        ...
        webSettings.setUserAgentString(webSettings.getUserAgentString() + " jjrb");
    ...
    protected boolean isHostnameAllowed(final String url) {
        ...
        if (actualHost == null) return false;//To avoid crash
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, HAdvancedWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
    ...
    public static class Browsers {
        ...
        public static void openUrl(final Activity context, final String url, final boolean withoutTransition) {
            ...
            if (getAlternative(context) != null)
    ...
    public void setIScrollChangeListener(IScrollChangeListener listener) {
